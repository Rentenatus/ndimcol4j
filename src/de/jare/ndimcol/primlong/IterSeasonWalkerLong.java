 ...
 */
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
public class IterSeasonWalkerLong implements IteratorWalkerLong {

    private final de.jare.ndimcol.ref.IterTapeWalker<ArrayMovieLong> outerWalker; // Walker for the outer ArrayTape
    private IteratorWalkerLong innerWalker; // Walker for the current inner ArrayTape or ArraySeason
    private final ArraySeasonLong season;
     ...
     */
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    public IterSeasonWalkerLong(ArraySeasonLong season) {
        this.season = season;
    ...
    public IteratorWalkerLong goLeafIndex(int index) {
        ...
        while (currentIndex <= index) {
            ...
            if (searchIndex < innerWalker.size()) {
                currentIndex = index;
                return new IterCoverWalkerLong(season, innerWalker.goLeafIndex(searchIndex));
            } else {
