 ...
 */
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
public class IterTapeWalkerLong implements IteratorWalkerLong {

    final ArrayTapeLong tape;
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public IterTapeWalkerLong(ArrayTapeLong tape) {
        this.tape = tape;
        this.currentIndex = 0;
        this.forward = true;
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public IterTapeWalkerLong(ArrayTapeLong tape, int atIndex) {
        this.tape = tape;
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    public IterTapeWalkerLong goFirst() {
        currentIndex = 0;
        forward = true;
        return this;
    }
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    public IterTapeWalkerLong goLast() {
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    public IterTapeWalkerLong goLeafIndex(int index) {
        if (index < 0 || index >= tape.size()) {
            throw new IndexOutOfBoundsException("Index: " + index + ", Size: " + tape.size());
        }
        currentIndex = index;
