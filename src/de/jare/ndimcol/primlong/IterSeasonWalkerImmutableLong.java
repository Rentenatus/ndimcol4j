 ...
 */
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
public class IterSeasonWalkerImmutableLong extends IterSeasonWalkerLong implements IteratorWalkerLong {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public IterSeasonWalkerImmutableLong(ArraySeasonLong season) {
        super(season);
    }
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    final public long removeForward() {
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    final public long removeBackward() {
        throw new IllegalCallerException("This walker doas not allow any changes.");
    }
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    final public boolean add(long element) {
        throw new IllegalCallerException("This walker doas not allow any changes.");
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    final public long set(long element) {
        throw new IllegalCallerException("This walker doas not allow any changes.");
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    final public boolean add(Collection<? extends Long> col) {
        throw new IllegalCallerException("This walker doas not allow any changes.");
