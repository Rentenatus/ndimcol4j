 ...
 */
 ...
 public class ArrayMatrixLong {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    de.jare.ndimcol.ref.ArrayTape<ArrayTapeLong> content;
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayMatrixLong(int cols, int rows, long initValue) {
        this.cols = cols;
        this.rows = rows;
        this.size = cols * rows;
        this.initValue = initValue;

        ArrayTapeLong template = new ArrayTapeLong(cols);
        for (int i = 0; i < cols; i++) {
            template.add(initValue);
        }
        this.content = new de.jare.ndimcol.ref.ArrayTape<>(rows);
        de.jare.ndimcol.ref.ArrayTape<ArrayMovieLong> s_content = new de.jare.ndimcol.ref.ArrayTape<>(rows);
        for (int i = 0; i < rows; i++) {
            ArrayTapeLong row = new ArrayTapeLong(cols);
            row.addMovie(template);
            this.content.add(row);
            s_content.add(row);
        }
        this.cover = new ArraySeasonLong(s_content, size);
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public long set(int col, int row, long value) {
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    // Primitives don't overwrite anything. 
    public boolean contains(long ob) {
        for (ArrayTapeLong row : content) {
            if (row.contains(ob)) {
                return true;
            }
        }
    ...
    public void clear() {
        ...
        this.cover = new ArraySeasonLong();
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayMovieLong toArrayMovie() {
    ...
    public boolean equals(Object ob) {
        if (!(ob instanceof ArrayMatrixLong)) {
            if (!(ob instanceof Collection<?>)) {
                return false;
            }
            return equalsCollection((Collection<?>) ob);
        }
        return equalsMatrix((ArrayMatrixLong) ob);
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public boolean equalsMatrix(ArrayMatrixLong col) {
        if (this == col) {
            return true;
        }
        if (col == null) {
    ...
    public int debug(PrintStream out, String prefix, int offset) {
        for (int i = 0; i < rows; i++) {
            ArrayMovieLong episode = content.get(i);
