 ...
 */
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
public class IterTapeWalkerFreezeShort extends IterTapeWalkerShort implements IteratorWalkerShort {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public IterTapeWalkerFreezeShort(ArrayTapeShort tape) {
        super(tape);
    ...
    public short removeBackward() {
        checkForConcurrentModification();
        short ret = super.removeBackward();
        this.initialUpdateCounter = tape.getUpdateCounter();
        return ret;
    }
