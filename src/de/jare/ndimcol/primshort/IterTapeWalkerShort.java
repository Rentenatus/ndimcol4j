 ...
 */
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
public class IterTapeWalkerShort implements IteratorWalkerShort {

    final ArrayTapeShort tape;
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public IterTapeWalkerShort(ArrayTapeShort tape) {
        this.tape = tape;
        this.currentIndex = 0;
        this.forward = true;
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public IterTapeWalkerShort(ArrayTapeShort tape, int atIndex) {
        this.tape = tape;
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    public IterTapeWalkerShort goFirst() {
        currentIndex = 0;
        forward = true;
        return this;
    }
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    public IterTapeWalkerShort goLeafIndex(int index) {
        if (index < 0 || index >= tape.size()) {
            throw new IndexOutOfBoundsException("Index: " + index + ", Size: " + tape.size());
        }
        currentIndex = index;
