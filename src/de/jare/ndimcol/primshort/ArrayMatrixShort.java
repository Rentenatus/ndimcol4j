 ...
 */
 ...
 public class ArrayMatrixShort {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    de.jare.ndimcol.ref.ArrayTape<ArrayTapeShort> content;
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayMatrixShort(int cols, int rows, short initValue) {
        this.cols = cols;
        this.rows = rows;
        this.size = cols * rows;
        this.initValue = initValue;

        ArrayTapeShort template = new ArrayTapeShort(cols);
        for (int i = 0; i < cols; i++) {
            template.add(initValue);
        }
        this.content = new de.jare.ndimcol.ref.ArrayTape<>(rows);
        de.jare.ndimcol.ref.ArrayTape<ArrayMovieShort> s_content = new de.jare.ndimcol.ref.ArrayTape<>(rows);
        for (int i = 0; i < rows; i++) {
            ArrayTapeShort row = new ArrayTapeShort(cols);
            row.addMovie(template);
            this.content.add(row);
            s_content.add(row);
        }
        this.cover = new ArraySeasonShort(s_content, size);
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public short get(int col, int row) {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public short set(int col, int row, short value) {
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    // Primitives don't overwrite anything. 
    public boolean contains(short ob) {
        for (ArrayTapeShort row : content) {
            if (row.contains(ob)) {
                return true;
            }
        }
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    // Primitives don't overwrite anything. 
    public boolean remove(short ob) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    public void clear() {
        ...
        this.cover = new ArraySeasonShort();
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayMovieShort toArrayMovie() {
    ...
    public boolean equals(Object ob) {
        if (!(ob instanceof ArrayMatrixShort)) {
            if (!(ob instanceof Collection<?>)) {
                return false;
            }
            return equalsCollection((Collection<?>) ob);
        }
        return equalsMatrix((ArrayMatrixShort) ob);
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public boolean equalsMatrix(ArrayMatrixShort col) {
        if (this == col) {
            return true;
        }
        if (col == null) {
    ...
    public int debug(PrintStream out, String prefix, int offset) {
        for (int i = 0; i < rows; i++) {
            ArrayMovieShort episode = content.get(i);
