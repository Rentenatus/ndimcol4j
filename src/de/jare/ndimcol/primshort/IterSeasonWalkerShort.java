 ...
 */
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
public class IterSeasonWalkerShort implements IteratorWalkerShort {

    private final de.jare.ndimcol.ref.IterTapeWalker<ArrayMovieShort> outerWalker; // Walker for the outer ArrayTape
    private IteratorWalkerShort innerWalker; // Walker for the current inner ArrayTape or ArraySeason
    private final ArraySeasonShort season;
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public IterSeasonWalkerShort(ArraySeasonShort season) {
        this.season = season;
    ...
    public short removeForward() {
        ...
        short ret = innerWalker.removeForward();
        currentIndex--;
        season.deepChanged();
    ...
    public short removeBackward() {
        ...
        short ret = innerWalker.removeBackward();
        season.deepChanged();
        season.updateCounter++;
        season.size--;
        return ret;
    ...
    public short set(short element) {
        ...
        final short ret = innerWalker.set(element);
    ...
    public IteratorWalkerShort goLeafIndex(int index) {
        ...
        while (currentIndex <= index) {
            ...
            if (searchIndex < innerWalker.size()) {
                currentIndex = index;
                return new IterCoverWalkerShort(season, innerWalker.goLeafIndex(searchIndex));
            } else {
                currentIndex = currentIndex + innerWalker.size();
                if (outerWalker.hasNext()) {
                    innerWalker = outerWalker.next().softWalker();
