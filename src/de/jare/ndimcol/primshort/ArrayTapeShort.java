 ...
 */
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
public class ArrayTapeShort implements ArrayMovieShort {
    ...
    private IterTapeWalkerShort softWalker;
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayTapeShort() {
        this.elementData = new short[DEFAULT_CAPACITY];
        this.size = 0;
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayTapeShort(int initialCapacityOrZero) {
        this.elementData = new short[initialCapacityOrZero > 0 ? initialCapacityOrZero : DEFAULT_CAPACITY];
        this.size = 0;
        this.page = DEFAULT_PAGE;
        this.updateCounter = 0;
        this.trimCountDown = DEFAULT_COUNTDOWN;
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayTapeShort(int initialCapacity, boolean fillout) {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayTapeShort(ArrayTapeShort original) {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayTapeShort(List<Short> list) {
        this.elementData = new short[list.size() + (DEFAULT_PAGE >> 4)];
    ...
    public void setBufferData(final short[] elementData) {
    ...
    public boolean equals(Object ob) {
        ...
        IterTapeWalkerShort walker = softWalker();
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    public boolean glueMovie(ArrayMovieShort movie) {
    ...
    public short set(int index, short element) {
        ...
        @SuppressWarnings("unchecked")
        short oldElement = elementData[index];
        elementData[index] = element;
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public boolean removeAll(short element) {
        int removed = 0;
    ...
    public boolean removeAll(Collection<?> col) {
        boolean modified = false;
         for (Object element : col) {
             if (element instanceof Short && removeAll((short)element)) {
                modified = true;
            }
        }
        if (trimCountDown < 0) {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    protected short removeFast(int index) {
        if (index >= size || index < 0) {
            throw new IndexOutOfBoundsException("Index: " + index + ", Size: " + size + ".");
        }
        @SuppressWarnings("unchecked")
        short ret = elementData[index];
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public short removeTrim(int index) {
        if (index >= size || index < 0) {
            throw new IndexOutOfBoundsException("Index: " + index + ", Size: " + size + ".");
        }
        @SuppressWarnings("unchecked")
        short ret = elementData[index];
        short[] newElementData = new short[size + page - 1];
    ...
    public boolean containsAll(Collection<?> col) {
        if (col == null) {
         ...
         for (Object element : col) {
             if ( !(element instanceof Short) || indexOf((short)element)== -1) {
                return false;
            }
        }
        return true;
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public int indexRemove(short element) {
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    public IterTapeWalkerShort softWalker() {
        if (softWalker != null) {
            return softWalker.goFirst();
        }
        softWalker = new IterTapeWalkerShort(this);
        return softWalker;
    }
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    public IterTapeWalkerShort softWalkerBackwards() {
        if (softWalker != null) {
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    public IterTapeWalkerShort leafWalker(int atIndex) {
        if (softWalker != null) {
            return softWalker.goLeafIndex(atIndex);
        }
        softWalker = new IterTapeWalkerShort(this, atIndex);
        return softWalker;
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public IterTapeWalkerShort walker() {
        return new IterTapeWalkerFreezeShort(this);
    }
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    public ArrayTapeShort splitInHalf() {
        if (size <= 1) {
            return null;
        }
        int halfSize = size / 2;
        ArrayTapeShort newTape = emptyMovie(size - halfSize + page);
        newTape.size = size - halfSize;
        newTape.elementData = new short[newTape.size];
        ...
        short[] newElementData = new short[halfSize];
    ...
    @Override
    public void copyToArray(short[] array, int offset) {
        if (array == null) {
    ...
    public ArrayMovieShort subMovie(int fromIndex, int toIndex) {
        ...
        ArrayTapeShort subMovie = emptyMovie(newSize);
        if (fromIndex < toIndex) {
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    public ArrayTapeShort emptyMovie(int initialCapacityOrZero) {
        ArrayTapeShort ret = new ArrayTapeShort(initialCapacityOrZero);
        ret.page = this.page;
        return ret;
    }
    ...
    public IteratorWalkerShort filterFirst(ShortPredicate predicate) {
        ...
        for (int i = 0; i < size; i++) {
             if (predicate.test(elementData[i])) {
                ...
                return new IterTapeWalkerShort(this, i);
            }
        }
        return null;
    }
    ...
    public ArrayMovieShort filterAll(ShortPredicate predicate) {
        ...
        ArrayMovieShort ret = emptyMovie(size >> 4);
        short element;
        for (int i = 0; i < size; i++) {
