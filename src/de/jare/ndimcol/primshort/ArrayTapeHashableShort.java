 ...
 */
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
public class ArrayTapeHashableShort extends ArrayTapeShort implements RentenatusHashable, StrategicHashableShort {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayTapeHashableShort(HashStrategyShort strategy) {
        super();
        this.hashCode = 0;
        this.hashComputed = true;
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayTapeHashableShort(int initialCapacityOrZero) {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayTapeHashableShort(ArrayTapeShort original) {
        super(original);
        this.hashCode = original.hashCode();
        this.hashComputed = true;
        this.strategy = (original instanceof StrategicHashableShort)
                ? ((StrategicHashableShort) original).getStrategy()
                : new HashStrategyShort();
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayTapeHashableShort(List<Short> list) {
        super(list);
        this.hashCode = 10127;
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayTapeHashableShort(List<Short> list, HashStrategyShort strategy) {
        super(list);
        this.hashCode = 10127;
        this.hashComputed = false;
        this.strategy = strategy;
    ...
    public ArrayTapeShort emptyMovie(int initialCapacityOrZero) {
        ArrayTapeHashableShort ret = new ArrayTapeHashableShort(initialCapacityOrZero);
