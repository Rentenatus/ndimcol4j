 ...
 */
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
public class IterSeasonWalkerImmutableShort extends IterSeasonWalkerShort implements IteratorWalkerShort {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public IterSeasonWalkerImmutableShort(ArraySeasonShort season) {
        super(season);
    }
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    final public short removeForward() {
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    final public short removeBackward() {
        throw new IllegalCallerException("This walker doas not allow any changes.");
    }
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    final public boolean add(short element) {
        throw new IllegalCallerException("This walker doas not allow any changes.");
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    final public short set(short element) {
        throw new IllegalCallerException("This walker doas not allow any changes.");
    ...
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    @Override
    final public boolean add(Collection<? extends Short> col) {
        throw new IllegalCallerException("This walker doas not allow any changes.");
