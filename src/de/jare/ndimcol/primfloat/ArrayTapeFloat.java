...
public class ArrayTapeFloat implements ArrayMovieFloat {
    ...
    private IterTapeWalkerFloat softWalker;
     ...
     */
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    public ArrayTapeFloat() {
        this.elementData = new float[DEFAULT_CAPACITY];
        this.size = 0;
     ...
     */
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    public ArrayTapeFloat(int initialCapacityOrZero) {
        this.elementData = new float[initialCapacityOrZero > 0 ? initialCapacityOrZero : DEFAULT_CAPACITY];
        this.size = 0;
        this.page = DEFAULT_PAGE;
        this.updateCounter = 0;
        this.trimCountDown = DEFAULT_COUNTDOWN;
     ...
     */
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    public ArrayTapeFloat(ArrayTapeFloat original) {
     ...
     */
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    public ArrayTapeFloat(List<Float> list) {
        this.elementData = new float[list.size() + (DEFAULT_PAGE >> 4)];
...
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    @Override
    public boolean glueMovie(ArrayMovieFloat movie) {
...
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    public float set(int index, float element) {
        ...
        @SuppressWarnings("unchecked")
        float oldElement = elementData[index];
        elementData[index] = element;
    ...
    public boolean removeAll(Collection<?> col) {
        boolean modified = false;
         for (Object element : col) {
             if (element instanceof Float && removeAll((float)element)) {
                modified = true;
            }
        }
        if (trimCountDown < 0) {
...
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    public float removeTrim(int index) {
        ...
        @SuppressWarnings("unchecked")
        float ret = elementData[index];
        float[] newElementData = new float[size + page - 1];
...
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    ...
    public boolean containsAll(Collection<?> col) {
        if (col == null) {
         ...
         for (Object element : col) {
             if ( !(element instanceof Float) || indexOf((float)element)== -1) {
                return false;
            }
        }
        return true;
     ...
     */
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    public int indexRemove(float element) {
...
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    @Override
    public IterTapeWalkerFloat softWalker() {
        if (softWalker != null) {
            return softWalker.goFirst();
        }
        softWalker = new IterTapeWalkerFloat(this);
        return softWalker;
    }
...
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    @Override
    public IterTapeWalkerFloat leafWalker(int atIndex) {
        if (softWalker != null) {
            return softWalker.goLeafIndex(atIndex);
        }
        softWalker = new IterTapeWalkerFloat(this, atIndex);
        return softWalker;
    }
     ...
     */
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    public IterTapeWalkerFloat walker() {
        return new IterTapeWalkerFreezeFloat(this);
    }
...
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    ...
    public ArrayTapeFloat splitInHalf() {
        ...
        int halfSize = size / 2;
        ArrayTapeFloat newTape = emptyMovie(size - halfSize + page);
        newTape.size = size - halfSize;
        newTape.elementData = new float[newTape.size];
        ...
        float[] newElementData = new float[halfSize];
...
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    ...
    public ArrayMovieFloat subMovie(int fromIndex, int toIndex) {
        ...
        ArrayTapeFloat subMovie = emptyMovie(newSize);
        if (fromIndex < toIndex) {
...
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    ...
    public ArrayTapeFloat emptyMovie(int initialCapacityOrZero) {
        ArrayTapeFloat ret = new ArrayTapeFloat(initialCapacityOrZero);
        ret.page = this.page;
        return ret;
    }
...
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    @SuppressWarnings("unchecked")
    @Override
    public IteratorWalkerFloat filterFirst(Predicate<? super Float> predicate) {
        if (predicate == null) {
            throw new NullPointerException("Predicate cannot be null.");
        }
        for (int i = 0; i < size; i++) {
             if (predicate.test(elementData[i])) {
                return new IterTapeWalkerFloat(this, i);
            }
        }
        return null;
    }
...
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    @SuppressWarnings("unchecked")
    @Override
    public IteratorWalkerFloat filterLast(Predicate<? super Float> predicate) {
        if (predicate == null) {
            throw new NullPointerException("Predicate cannot be null.");
        }
        for (int i = size - 1; i >= 0; i--) {
...
// This code has been generated. Please do not make any changes here. Modify package 'de.jare.ndimcol' and use 'GeneratePrimitiveJavaFiles'
    @SuppressWarnings("unchecked")
    @Override
    public ArrayMovieFloat filterAll(Predicate<? super Float> predicate) {
        if (predicate == null) {
            throw new NullPointerException("Predicate cannot be null.");
        }
        ArrayMovieFloat ret = emptyMovie(size >> 4);
        float element;
        for (int i = 0; i < size; i++) {
