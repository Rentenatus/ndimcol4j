...
/**
 * A validator for primitive {@code float} values that allows absolute tolerance margins.
 * <p>
 ...
 * upperTolerance = 3.0
 * expected = 15.0
 * valid range = [13.0, 18.0]
 *
 * observed = 13.0 &rarr; ACCEPTABLE
...
public class ValidatorAbsToleranceCheckFloat implements MovieValidatorFloat {
     ...
     */
    private final float uperTolerance;
     ...
     */
    public ValidatorAbsToleranceCheckFloat(float lowerTolerance, float uperTolerance) {
     ...
     */
    public ValidatorAbsToleranceCheckFloat(float tolerance) {
