 ...
 */
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
public class IterCoverWalkerFloat implements IteratorWalkerFloat {

    final IteratorWalkerFloat inner;
    final ArraySeasonFloat observer;
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public IterCoverWalkerFloat(ArraySeasonFloat observer, IteratorWalkerFloat inner) {
        this.inner = inner;
    ...
    public IteratorWalkerFloat gotoIndex(int index, boolean headForward) {
        IteratorWalkerFloat ret = inner.gotoIndex(index - observer.getOffset(inner.getRelatedMovie()), headForward);
