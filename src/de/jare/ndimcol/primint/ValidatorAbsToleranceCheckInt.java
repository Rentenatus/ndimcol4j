...
/**
 * A validator for primitive {@code int} values that allows absolute tolerance margins.
 * <p>
...
public class ValidatorAbsToleranceCheckInt implements ValidatorInt {
     ...
     */
    private final int uperTolerance;
     ...
     */
    public ValidatorAbsToleranceCheckInt(int lowerTolerance, int uperTolerance) {
     ...
     */
    public ValidatorAbsToleranceCheckInt(int tolerance) {
