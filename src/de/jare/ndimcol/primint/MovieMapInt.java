 ...
 */
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
public class MovieMapInt<V> {

    private final SortedSeasonSetInt keys;
     ...
     */
    public MovieMapInt() {
        this.keys = new SortedSeasonSetInt();
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    private MovieMapInt(final SortedSeasonSetInt keys, final ArrayMovie<V> values) {
        this.keys = keys;
        this.values = values;
        ensureSameSize();
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public ArrayMovieInt getKeysMovie() {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public IteratorWalkerInt getKeysWalker() {
        return new IterSeasonWalkerImmutableInt(keys);
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public int[] getKeysArray(final int[] arr) {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public MovieEntryInt<V> getEntry(final int index) {
        return new MovieEntryInt(keys.get(index), values.get(index));
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public final SortedSeasonSetAddResult put(final int key, final V value) {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public V getByKey(final int key) {
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public MovieEntryInt<V> removeAt(final int index) {
        final int removedKey = keys.removeAt(index);
        final V removedValue = values.removeAt(index);
        ensureSameSize();
        return new MovieEntryInt(removedKey, removedValue);
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public V removeByKey(final int key) {
        final int index = keys.indexOf(key);
        if (index < 0) {
            return null;
        }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public MovieMapInt<V> subMovieMap(final int fromIndex, final int toIndex) {
        final ArrayMovieInt subKeysMovie = keys.subMovie(fromIndex, toIndex);
        final SortedSeasonSetInt subKeys = keys.union(subKeysMovie.emptyMovie(0));
        subKeys.addMovie(subKeysMovie);

        return new MovieMapInt(
                subKeys,
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public MovieMapInt<V> cloneMovieMap() {
        final ArrayMovieInt clonedKeysMovie = keys.cloneMovie();
        final SortedSeasonSetInt clonedKeys = keys.union(clonedKeysMovie.emptyMovie(0));
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public void forAll(final Consumer<MovieEntryInt<V>> action) {
        final int size = size();
        for (int i = 0; i < size; i++) {
            action.accept(new MovieEntryInt(keys.get(i), values.get(i)));
        }
    }
    ...
    // #### This code has been generated. Please do not make any changes here.
    // #### Modify package 'de.jare.ndimcol.ref' and use 'GeneratePrimitiveJavaFiles'
    public static record MovieEntryInt<V>(int key, V value) {
