...
public interface ArrayMovie<T> extends Collection<T> {
    ...
    /**
     * Splits this movie into two movies. This movie contains the first half of the elements,
     * and the second movie contains the second half of the elements.
     * Half is to be understood colloquially; it is not guaranteed that the size of both parts is the same.
     *
    ...
    /**
     * Returns a simple shared IteratorWalker for this movie.
     * This simple iterator can not be used parallel.
     * @return this one simple IteratorWalker for this movie
     */
    public IteratorWalker<T> softWalker();

    /**
     * Returns a shared IteratorWalker for deepest ArrayTape of movie.
    ...
    /**
     * Index of the first equal element in the movie. If the specified element is null, it checks for null elements in the ArrayTape.
    ...
    /**
     * Check if the movies in a season are to big and need to be split or if they are to small and need be glued together.
     * Nothing to do for a movie itself.
     */
